...
M_area=200;   N_Ch=Dens*M_area;   %定义膜面积，单位是um^2
...
Freq=Freq/(nfft*delta_t);  %这个是最标准的！！！！今后一定不要再改。2025/6/5!!!
 %plot(f,AV_df_V);
save PowerSpectVM200V77dens18 AV_df_V   Freq T_step nfft Num_aver delta_t M_area  length_PS Cmd gL gK V_K VL;
